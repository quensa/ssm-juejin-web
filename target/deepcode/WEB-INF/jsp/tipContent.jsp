        ...
        <div class="panel-heading" style="background-color: white">
            <div>
                <div class="panel-heading" style="background-color: white">
                    ...
                    <div class="container">
                        <button onclick="a1()" type="button" class="btn btn-default" id="btn_collect">
            ...
            <li class="list-group-item">
                <div style="height: auto; ">
                    <div>
                        ...
                        <c:if test="${reply.user.user_id == tip.user_id}"><span
                                class="label label-info">楼主</span></c:if>
                        &nbsp;
...
<script type="text/javascript">
    $(function () {
        ...
        $("#fav").click(function () { //给button设置点击事件
            $.ajax({
                url: "${pageContext.request.contextPath}/addFavor", //这个对应Controller的URL，和你们以前表单里面的action一样
...
<script type="text/javascript">
    function a1() {
        $.ajax({
            ...
            success: $("#btn_collect").click(function () {
